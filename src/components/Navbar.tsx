...
function Navbar(){
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        ...
        <li className="relative overflow-hidden group">
            <a href="#" className="block py-2 px-3 text-rh-primarygrey rounded-sm hover:bg-white md:p-0">Home</a>
            <span className="absolute bottom-0 left-0 w-0 h-1 bg-rh-primarygrey transition-all duration-300 group-hover:w-full"></span>
        </li>
        <li className="relative overflow-hidden group">
            <a href="#" className="block py-2 px-3 text-rh-primarygrey rounded-sm hover:bg-white md:p-0">Sobre nós</a>
            <span className="absolute bottom-0 left-0 w-0 h-1 bg-rh-primarygrey transition-all duration-300 group-hover:w-full"></span>
        </li>
        <li className="relative overflow-hidden group">
